...
if (((consecvic2 < 3) && (spctrbon < 2) || (consecvic2 < 3)) && (dice5 > dice6) && (magsp > 1) && (magsp3 < 1) && (bonchn2 < 3) && (ultsp < 4))
{
...
if ((spctrbon > 1) && (dice5 > dice6) && (magsp3 < 1) && (magsp < 2) && (ultsp < 4))
{
...
ultdup = 0;
diceQ2 = 0;
magsp = 0;//*THIS IS TO STOP MAGIC SP AND SPECIAL BON FROM PRINTING AT SAME TIME; TRIGGER, MAGSP > 1, FOR SP BON, MAG SP MUST BE LESS THAN < 2!
if (diflev < 6)
{
emagsup = 0;
emagsup5 = 0;
